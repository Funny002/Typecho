...
<div class="var-sidebar">
	<div class="var-sidebar-top">
		<div class="var-sidebar-btn">
			<span class="sidebar-btn mdui-text-color-theme-accent">
				<i class="mdui-icon material-icons">&#xe5c4;</i>
			</span>
		</div>
		<div class="var-sidebar-img">
	...
	<div class="var-sidebar-div">
		...
		<ul class="list-none">
			<li class="var-sidebar-div-li">
				<a class="var-search-btn mdui-text-color-theme-accent" title="搜索">
					<i class="mdui-icon material-icons">&#xe8b6;</i>
					<span>搜索</span>
				</a>
			</li>
...
<div class="var-sidebar-nav sidebar-btn"></div><!-- /~ end #sidebar ~/ -->
